...
| 训练过程 | 识别结果 | 添加训练数据 |
| :------: | :------: | :----------: |
| ![训练演示](./image/训练演示.gif) | ![识别演示](./image/识别演示.gif) | ![输入训练数据演示](./image/输入训练数据演示.gif) |
...
https://i0.hdslb.com/bfs/archive/click_here_thumbnail.jpg

点击上面的图片即可跳转到 B 站观看原视频。
（封面图片为占位示例，建议替换为真实的视频封面图）
